...
namespace Dapper.SimpleCRUDTests
{
    class Program
    {
        ...
        {
            using (var connection = new SqlConnection(@"Data Source=.\pawa2012;Initial Catalog=Master;Integrated Security=True"))
            {
                connection.Open();
                try
                {
            ...
            using (var connection = new SqlConnection(@"Data Source = .\pawa2012;Initial Catalog=DapperSimpleCrudTestDb;Integrated Security=True"))
            {
                connection.Open();
